...
echo"<table>";
echo"<tr><td>VIN</td><td>Make</td><td>Model</td><td>Year</td><td>Trim</td><td>Body Class</td><td>Cab Type</td><td>Drive Type</td><td>Transmission Style</td><td>Front Airbag Loc</td><td>Side Airbag Loc</td></tr>\n";
